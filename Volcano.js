...
exports.handler = (message, prefix) => {
  if (message.content.startsWith(`${prefix}rps`)) {
    const row = new MessageActionRow().addComponents(
      new MessageButton().setCustomId("rock").setEmoji("🪨").setStyle("PRIMARY"),
      new MessageButton().setCustomId("paper").setEmoji("🧻").setStyle("PRIMARY"),
      new MessageButton().setCustomId("scissors").setEmoji("✂️").setStyle("PRIMARY")
    );
